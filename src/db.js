...
(function (Logic) {
    var Db = (function () {
        ...
        Db.getAllLessons = function () {
            return Db.lessons;
        };
        Db.getLesson = function (lessonId) {
            return Db.lessons[lessonId - 1];
        };
        Db.getLyrics = function (lyricsId) {
...
Logic.Db.lyrics.push(lessonProtegeMoi);
var lyricsAlorsOnDanse = ({
...
var lyricsLePetitPrince = {
    timeCode: [8.133333333333333, 10.2, 16.4, 24.066666666666666, 31.8, 40.53333333333333, 44.2, 53, 56.86666666666667, 61.2, 64.13333333333334, 66.2],
...
function createVocabulary(lyrics) {
    ...
    var vocabulary = [];
    var wordIndex = 0;
    lineSeparated.forEach(function (line, lineIndex) {
